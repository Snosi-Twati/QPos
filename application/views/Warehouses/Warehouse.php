...
//                $A=false;
                $this->Desg->Create_From_Tabels_With_Ajax("warehouses",false,false,"ProcessControlDatabases/ProConDBinByAjax","حفظ",$A);  
                ?>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">قائمة مخازن</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                
                <?PHP
                //$this->load->model('Desg');
                $this->Desg->ViewData("warehouses");  
                ?>
