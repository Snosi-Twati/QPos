...
//                $A=false;
                $this->Desg->Create_From_Tabels_With_Ajax("currency",false,false,"ProcessControlDatabases/ProConDBinByAjax","حفظ",$A);  
                ?>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">قائمة عملات</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                
                <?PHP
                //$this->load->model('Desg');
                $this->Desg->ViewData("currency");  
                ?>
