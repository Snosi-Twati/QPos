        ...
        <div class="box">
            ...
            <div class="box-body">
                <?PHP 
                    ...
                    {
                        $this->Desg->Create_Form_InputFrm('InvoiceNumber',"Claims/DataClaimsListMultiInput?ClaimID=".$this->input->get('ClaimID')."&CompanyID=".$this->input->get('CompanyID')."&InvoiceNumber=".$this->input->get('InvoiceNumber')."","فتح فاتورة",FALSE);
                    }elseif($this->input->post('ClaimID')&&$this->input->post('CompanyID')){
                        $this->Desg->Create_Form_InputFrm('InvoiceNumber',"Claims/DataClaimsListMultiInput?ClaimID=".$this->input->get('ClaimID')."&CompanyID=".$this->input->post('CompanyID')."&InvoiceNumber=".$this->input->post('InvoiceNumber')."","فتح فاتورة",FALSE);
                    }else{
                        $this->Desg->Create_Form_InputFrm('InvoiceNumber',"Claims/DataClaimsListMultiInput?ClaimID=".$this->input->get('ClaimID')."","فتح فاتورة",FALSE);
                    }
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?PHP
                    ...
                    $this->Desg->Create_From_Tabels_Add_New_Filed("claimsdetails",FALSE,FALSE,"ProcessControlDatabases/ProConDBin","اضافة خدمة",$A,$ViewFld, $keepPOST,$hiddenField);  
                    ?>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?PHP
                    ...
                    $this->Desg->Create_From_Tabels_Add_New_Filed("claimsdetails",FALSE,FALSE,"ProcessControlDatabases/ProConDBinMultiRow","اضافة خدمة",$A,$ViewFld, $keepPOST,$hiddenField);  
                    ?>
