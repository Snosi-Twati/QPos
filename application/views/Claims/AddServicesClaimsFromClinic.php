            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    if($this->input->get('ClaimID')==NULL){
                        $btndata[]=array(
                            'Url'=> "Claims/AddServicesClaimsFromClinic?" ,
                            'TID'   =>  'Claim',
                            'ID'    =>  'add',
                            'Title'=>'مطالبة'
                        );
                        ...
                        $btndata[]=array(
                            'Url'=> "Claims/AddServicesClaimsFromClinic?ClaimID=".$this->input->get('ClaimID')."&" ,
                            'TID'=>'Diagnosis',
                            'ID'=>'add',
                            'Title'=>'تشخيص'
                        );
    ...
    <div class="row">
        ...
        <div class="col-xs-12" >
            ...
            if($this->input->post('BeneficiaryID')==null){
                ...
                $this->Desg->Create_From_Tabels('claims',FALSE,FALSE,'Claims/AddServicesClaimsFromClinic?Claim=add',"تاكد من البطاقة",FALSE,$ViewFld,FALSE,FALSE);
        ...
        <div class="col-xs-12" >
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    $this->Desg->Create_Form_InputFrmGet('InvoiceNumber','Claims/AddServicesClaimsFromClinic',"فتح فاتورة خدمات",TRUE);
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    $this->Desg->Create_Form_With_DropDownGet($arry,'Claims/AddServicesClaimsFromClinic',"اختر",$Cnd,TRUE);
                    //$this->Desg->Create_From_Tabels('claimsdetails',FALSE,FALSE,'Claims/AddServicesClaimsFromClinic',"فتح فاتورة خدمات",FALSE,$ViewFld);
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    $this->Desg->Create_From_Tabels('claimsdetailsinitial',FALSE,FALSE,'ProcessControlDatabases/DataServicesClinic',"اضافة  خدمات",$A,$ViewFd,FALSE,$hiddenField);
                ...
                <div class="box-header">
                    ...
                    <div class="box-body fa-b ">
                        ...
                        ////////////////////////////////////////////
                            ...
                            $this->Desg->ViewDataWithExRowWithMultiCond('claimsdetailsinitial',FALSE,$Fld,$Ar,$CondCD); 
