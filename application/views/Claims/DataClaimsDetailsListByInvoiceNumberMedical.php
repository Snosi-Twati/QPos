            ...
            <div class="box-body">
                <?PHP 
                    if($this->input->get('ClaimID')&&$this->input->get('CompanyID'))
                    {
                        ...
                        $this->Desg->Create_Form_InputFrm('ProductionCode',"Claims/DataClaimsDetailsListByInvoiceNumberMedical?ClaimID=".$this->input->get('ClaimID')."&CompanyID=".$this->input->get('CompanyID')."&InvoiceNumber=".$this->input->get('InvoiceNumber')."","فتح فاتورة",FALSE);
                    }elseif($this->input->post('ClaimID')&&$this->input->post('CompanyID')){
                        
                        $this->Desg->Create_Form_InputFrm('ProductionCode',"Claims/DataClaimsDetailsListByInvoiceNumberMedical?ClaimID=".$this->input->get('ClaimID')."&CompanyID=".$this->input->post('CompanyID')."&InvoiceNumber=".$this->input->post('InvoiceNumber')."","فتح فاتورة",FALSE);
                    }else{
                        
                        $this->Desg->Create_Form_InputFrm('ProductionCode',"Claims/DataClaimsDetailsListByInvoiceNumberMedical","فتح فاتورة",FALSE);
                    }
