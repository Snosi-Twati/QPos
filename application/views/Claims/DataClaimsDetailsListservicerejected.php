...
//                            $CCD            =       $this->Pros->Get_Filed_AQ_Multi_Cond_Ary('listofservicerejected','ClaimServiceID');
...
//                                $CondCD['ClaimID']              =   $this->input->get('ClaimID');
                            $CondCD         =      FALSE;
                            $this->Desg->ViewDataWithExRowWithMultiCond('claimsdetailsservicerejected',$ArrCol,$Fld,$Ar,$CondCD);
                        }
                        ////////////////////////////////////////////
